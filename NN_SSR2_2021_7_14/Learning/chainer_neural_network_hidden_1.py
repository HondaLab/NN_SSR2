...
is_right_start = 'n'
hidden_num_information = input("please tell me the loop start number of hidden layer : ")
while 1:
...
hidden_start = int(hidden_num_information)

is_right_end = 'n'
hidden_num_information = input("please tell me the loop end number of hidden layer : ")
while 1:
    for i in range(100,2000):
        if str(hidden_num_information) == str(i) and int(hidden_num_information) > hidden_start:
            is_right_end = 'y'
    if str(is_right_end) == 'y':
        ...
        print("The information what you input can not read , please input it agian")
        hidden_num_information = input("please tell me the loop end number of hidden layer : ")
hidden_end = int(hidden_num_information)

#print(hidden_start,hidden_end)
...
hidden_num = range(hidden_start,hidden_end,10)
