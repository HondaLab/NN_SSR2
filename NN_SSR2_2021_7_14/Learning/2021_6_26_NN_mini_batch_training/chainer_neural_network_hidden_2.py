...
is_right_start = 'n'
hidden_num_information = input("please tell me the loop start number of hidden layer one : ")
while 1:
    for i in range(100,2000):
        if str(hidden_num_information) == str(i):
            is_right_start = 'y'
    if str(is_right_start) == 'y':
        break
    else:
        print("The information what you input can not read , please input it agian")
        hidden_num_information = input("please tell me the loop start number of hidden layer one : ")

hidden_start_one = int(hidden_num_information)

is_right_end = 'n'
hidden_num_information = input("please tell me the loop end number of hidden layer one : ")
while 1:
    for i in range(100,2000):
        if str(hidden_num_information) == str(i) and int(hidden_num_information) > hidden_start_one:
            is_right_end = 'y'
    if str(is_right_end) == 'y':
        break
    else:
        print("The information what you input can not read , please input it agian")
        hidden_num_information = input("please tell me the loop end number of hidden layer one : ")
hidden_end_one = int(hidden_num_information)
########################################################################################################################33

is_right_start = 'n'
hidden_num_information = input("please tell me the loop start number of hidden layer two : ")
while 1:
    for i in range(100,2000):
        if str(hidden_num_information) == str(i):
            is_right_start = 'y'
...
hidden_start_two = int(hidden_num_information)


is_right_end = 'n'
hidden_num_information = input("please tell me the loop end number of hidden layer two : ")
while 1:
    for i in range(100,2000):
        if str(hidden_num_information) == str(i) and int(hidden_num_information) > hidden_start_two:
            is_right_end = 'y'
    if str(is_right_end) == 'y':
        break
    else:
        print("The information what you input can not read , please input it agian")
        hidden_num_information = input("please tell me the loop end number of hidden layer two : ")
hidden_end_two = int(hidden_num_information)

#print(hidden_start_one,hidden_end_one,hidden_start_two,hidden_end_two)
...
def net_train(batch_size,hidden_number1,hidden_number2,EPOCH,STOP_ERROR,ALPHA,BETA1,BETA2,EPS,ETA,WEIGHT_RATE):
...
hidden_num1 = range(hidden_start_one,hidden_end_one,20)
hidden_num2 = range(hidden_start_two,hidden_end_two,20)
...
for i in hidden_num1:
    for p in hidden_num2:
        hidden_num_loss_train[ii,pp] = net_train(BatchSize,i,p,Epoch,Stop_Error,Alpha,Beta1,Beta2,Eps,Eta,Weight_Decay_Rate)
