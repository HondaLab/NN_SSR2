...
file_name = os.path.basename('_parameter_change_Eta_hidden_1')
...
for change_Eta in change_Eta_list:
    change_Eta_loss_list[0,j],have_epoch_list[0,j] = net_train(hidden_num,Epoch,Stop_Error,Alpha,Beta1,Beta2,Eps,change_Eta,Weight_Decay_Rate)
